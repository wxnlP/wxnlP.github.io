...
![image-20250317195809263](10-TF/image-20250317195809263.png)

`tf_static`是一个静态坐标变换话题，可以用来发布静态设备的坐标。例如：雷达、相机等坐标固定的设备。

计算坐标系关系后，再次查看会多一个`tf`动态坐标变换话题，可以用来发布动态设备的坐标。例如：轮子这类坐标会实时变化的设备。

![image-20250317201444428](10-TF/image-20250317201444428.png)
...
![image-20250317201610506](10-TF/image-20250317201610506.png)
...
![image-20250317201953097](10-TF/image-20250317201953097.png)
...
![image-20250317202404831](10-TF/image-20250317202404831.png)
...
![image-20250317232424782](10-TF/image-20250317232424782.png)
...
![image-20250318113745422](10-TF/image-20250318113745422.png)
