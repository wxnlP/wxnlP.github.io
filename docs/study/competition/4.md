...
![1708242805223](我的工创赛2023/1708242805223.png)

**铝材连接键**：建议使用这种直角角码；我们也用过一些内置的连接件并不好用，当时考虑装亚克力板好装但恰恰相反，所以不推荐，直角角码相对安装更简单。

![1708242924344](我的工创赛2023/1708242924344.png)

![1708243045701](我的工创赛2023/1708243045701.png)

前面提到运输过程中螺丝容易掉，所以在铝材底部用直角铁固定，防止结构变型。

![1708243175301](我的工创赛2023/1708243175301.png)
...
![1708243391533](我的工创赛2023/1708243391533.png)
...
![1708260715405](我的工创赛2023/1708260715405.png)
...
![1708244316987](我的工创赛2023/1708244316987.png)
...
![1708249530582](我的工创赛2023/1708249530582.png)
...
![1708250207978](我的工创赛2023/1708250207978.png)
...
![1708250513291](我的工创赛2023/1708250513291.png)

#### 满载检测

选用超声波，根据测距判断是否满载。因为垃圾桶规定为透明，红外测距会受到影响，超声波则不会受到影响。

![1708261211492](我的工创赛2023/1708261211492.png)
...
![1708330842223](我的工创赛2023/1708330842223.png)
...
![1708343507323](我的工创赛2023/1708343507323.png)

解释一下**文件夹下打开终端**，例如：在**yolov5-lite文件夹**下打开终端，即终端位置在**yolov5-lite文件夹**位置。

![1708343830872](我的工创赛2023/1708343830872.png)

操作方法为默认终端输入`cd + your_path`，例如：

![1708343950823](我的工创赛2023/1708343950823.png)
...
![1708332404336](我的工创赛2023/1708332404336.png)

![1708329910522](我的工创赛2023/1708329910522.png)
...
![1708331536097](我的工创赛2023/1708331536097.png)

将**v5lite-s.pt**文件转移到树莓派下**yolov5-lite文件夹**下

![1708332518118](我的工创赛2023/1708332518118.png)

4. **摄像头配置**

检测树莓派是否有**opencv**，打开终端，输入`python3`调出python终端，输入`import cv2`不报错即可

![1708330217813](D:/A-Typora_MarkDown/1/competition/https:/cdn.jsdelivr.net/gh/wxnlP/pic/competition/1708330217813.png)
...
![1708344562343](我的工创赛2023/1708344562343.png)
...
![1708344698894](我的工创赛2023/1708344698894.png)

Ctrl+c退出，输入`ls /dev/video*`查看摄像头设备，一般是0/1

![1708334429106](我的工创赛2023/1708334429106.png)
...
![1708333928679](我的工创赛2023/1708333928679.png)
...
![1708345128636](我的工创赛2023/1708345128636.png)
...
![1708946094611](我的工创赛2023/1708946094611.png)
...
![1708503608585](我的工创赛2023/1708503608585.png)
...
![1708947182342](我的工创赛2023/1708947182342.png)
