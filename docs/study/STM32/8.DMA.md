...
![image-20241227102219912](8.DMA/image-20241227102219912.png)
...
![image-20241227105325039](8.DMA/image-20241227105325039.png)
...
![image-20241227112408133](8.DMA/image-20241227112408133.png)
...
![image-20241227112945253](8.DMA/image-20241227112945253.png)
...
![image-20241227115032257](8.DMA/image-20241227115032257.png)
...
![image-20241227130438600](8.DMA/image-20241227130438600.png)

![image-20241226222231023](8.DMA/image-20241226222231023.png)
...
![image-20241227131121937](8.DMA/image-20241227131121937.png)

### 8.4.2 ADC单次转换扫描模式DMA转运

这里继续借鉴江协科技的图，我将两个电位计接在PA3和PA4，也可以节热敏电阻等可以测模拟量的传感器。

![7-1 AD单通道](8.DMA/7-1%20AD%E5%8D%95%E9%80%9A%E9%81%93.jpg)

STM32CubeMX配置

![image-20241228230805669](8.DMA/image-20241228230805669.png)

DMA设置，半字传输

![image-20241228231106505](8.DMA/image-20241228231106505.png)

配置串口输出

![image-20241228231939358](8.DMA/image-20241228231939358.png)

配置时钟

![image-20241228230840274](8.DMA/image-20241228230840274.png)
...
![image-20241228233920303](8.DMA/image-20241228233920303.png)

### 8.4.3 ADC连续转换扫描模式DMA循环转运

开启ADC连续模式，经测试这里需要把 **采样时间提高** ，不然采不到数据。

![image-20241229002825401](8.DMA/image-20241229002825401.png)

DMA循环模式，其余与上个工程一致

![image-20241228234124020](8.DMA/image-20241228234124020.png)
